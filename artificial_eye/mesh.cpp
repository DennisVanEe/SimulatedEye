...
bool syn_eye::Mesh::loadValues(const vector<Vertex>& vertices, const vector<GLuint>& indices, const vector<Texture>& textures)
{
	m_vertices = vertices;
	m_indices = indices;
	m_textures = textures;
...
void syn_eye::Mesh::draw(Shader& shader) const
{
