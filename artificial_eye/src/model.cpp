...
ee::Model::Model(std::string dir) :
	m_dir(dir)
{
}

void ee::Model::draw(Shader& shader) const
{
...
bool ee::Model::load(string* errorMsg)
{
...
vector<ee::Texture> ee::Model::loadTexture(const aiMaterial* mat, aiTextureType type, TextType typeName, bool* check)
{
	using namespace ee;
...
ee::Mesh ee::Model::processMesh(const aiMesh* mesh, const aiScene* scene, bool* check)
{
...
void ee::Model::processNode(aiNode* node, const aiScene* scene, bool* check)
{
	bool correctLoad;
