...
syn_eye::ImagePlane::ImagePlane(size_t width, size_t height) :
	m_width(width),
	m_height(height),
...
syn_eye::ImagePlane::~ImagePlane()
{
	glDeleteTextures(1, &m_texture);
}

bool syn_eye::ImagePlane::setPixel(size_t x, size_t y, Color color)
{
...
void syn_eye::ImagePlane::calculateImage()
{
	/*glDeleteTextures(1, &m_texture);
...
void syn_eye::ImagePlane::draw(Renderer* renderer)
{
